...
#' @param labels Optional. labels in columnName to which \code{desiredDistribution} will relate to. Default NA will assume equal distributions between all labels.
