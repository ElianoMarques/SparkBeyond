...
modModel = learn(projectName = "custom_function_example",
    trainData = data,
    target = "target",
    featureGenerationCtrl = featureGenerationControl(maxFeaturesCount = 5),
    # using a function from the web in the following url    	
    knowledgeCtrl = knowledgeControl(customFunctions = list("https://raw.githubusercontent.com/mesagie/etcetra/master/SampleFunctions.scala")),
