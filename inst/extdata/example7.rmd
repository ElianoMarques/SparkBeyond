...
<br>
```{r example7_1, eval=TRUE, results='asis'}
data = data.frame(number = 1:500, target = 1:500 %% 7 == 0)
```


```{r example7_2, eval=TRUE, message=FALSE, results='hide'}
...
```{r example7_3, eval=TRUE, results='asis'}
modModel$features()[1:1,c("idx","feature")]
```

```{r example7_4, echo=FALSE,eval = FALSE, message=FALSE}
