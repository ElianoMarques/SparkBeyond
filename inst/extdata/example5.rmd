...
<br>
### Tweets sentiment ###
```{r example5_1, eval=TRUE, message=FALSE, results='hide'}
...
```{r example5_2, eval=TRUE, results='asis'}
library(xtable)
...
```{r example5_3, eval=TRUE, message=FALSE, results='hide'}
...
```{r example5_4, eval=TRUE, results='asis'}
library(xtable)
...
```{r example5_5, eval = TRUE, message=FALSE}
