...
```{r example2_1, echo=FALSE, eval = TRUE, message=FALSE, results='hide'}
library(SparkBeyond)
```
...
<br>
```{r example2_2, eval=TRUE, message=FALSE, results='hide'}
...
<br>
```{r example2_3, eval=TRUE, results='asis'}
library(xtable)
...
```{r example2_4, eval = TRUE, message=FALSE}
